...
public class PlaylistTest extends TestCase {
    ...
    public void test_sortByArtist() {
    	...
    	aPlaylist= new Playlist<Song>("Playlist Title");
        song1 = new Song("Artist1", "A", 5.00);
        song2 = new Song("Artist4", "Z", 4.50);
        song3 = new Song("Artist3", "C", 4.00);
        song4 = new Song("Artist2", "K", 5.50);
        aPlaylist.addtoPlist(song1);
        aPlaylist.addtoPlist(song2);
        aPlaylist.addtoPlist(song3);
        aPlaylist.addtoPlist(song4);
    	Collections.sort(aPlaylist, new ArtistCompare());
    	assertEquals(0, aPlaylist.findSong(song1));
        assertEquals(1, aPlaylist.findSong(song4));
        assertEquals(2, aPlaylist.findSong(song3));
        assertEquals(3, aPlaylist.findSong(song2));
    }
    ...
    public void test_sortByTitle() {
    	...
    	aPlaylist= new Playlist<Song>("Playlist Title");
        song1 = new Song("Artist1", "A", 5.00);
        song2 = new Song("Artist2", "D", 4.50);
        song3 = new Song("Artist4", "C", 4.00);
        song4 = new Song("Artist3", "B", 5.50);
        aPlaylist.addtoPlist(song1);
        aPlaylist.addtoPlist(song2);
        aPlaylist.addtoPlist(song3);
        aPlaylist.addtoPlist(song4);
    	Collections.sort(aPlaylist, new TitleCompare());
    	assertEquals(0, aPlaylist.findSong(song1));
        assertEquals(1, aPlaylist.findSong(song4));
        assertEquals(2, aPlaylist.findSong(song3));
        assertEquals(3, aPlaylist.findSong(song2));
